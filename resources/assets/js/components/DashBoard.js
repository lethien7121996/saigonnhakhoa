...
const { bacsilist } = this.state;
  ...
  <div className="col-lg-6">
              ...
              <input type="text" className="form-control mydatepicker"  name="ngaythanhtoan" autocomplete="off" placeholder="mm/dd/yyyy" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
           
              </div>
              <div className="input-group hidden" id="khoanngaydatao">
              <input className="form-control input-daterange-datepicker" type="text" autocomplete="off" name="khoangngaythanhtoan" value=""  placeholder="mm/dd/yyyy - mm/dd/yyyy" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
        ...
        <div className="row">
                    <div className="col-lg-12">
                        <div className="white-box">
                            <h3 className="box-title m-b-0">Danh sách khách hàng thanh toán<button className="btn btn-primary" onClick={this.handleReset}><i class="fa fa-refresh"></i></button></h3>
