...
class TaoThanhToan extends Component {
    ...
    this.state = {
      ...
      usercurrent: [],
        ...
        tongphaitra: '',
        tongdatra: '',
        hinhthucthanhtoan: 'Chưa chọn hình thức',
...
handleFieldChange (event) {
   ...
   else
   {
     if(event.target.name == 'tienthanhtoan')
     {
      ...
      for(var i=0; i<=(selectdv.length-1); i++)
      {
       ...
       var saugiam=selectdv[i].childNodes[4].innerText.replaceAll('.', '')
       var dathanhtoan=selectdv[i].childNodes[6].childNodes[0].value.replaceAll('.', '')
       var thanhtoantruoc=selectdv[i].childNodes[5].innerText.replaceAll('.', '')
       chitietkhoan.push({ 
           "id" : i,
           "ngay" : ngay,
           "dieutri"  : dieutri,
        ...
        console.log(chitietkhoan)
         ttt=Number(ttt)+Number(selectdv[i].childNodes[6].childNodes[0].value.replaceAll('.', ''))
 ...
 getdulieuxoa(event)
  ...
  render() {
 const { thanhtoan,chiphi,thongkechiphi,chitietthanhtoan,tongphaitra,tongdatra,tongconlai,usercurrent } = this.state
          ...
          <div className="GOK0K1ECDRB">
            <div>
              ...
              {(() => {
                         ...
                         {
                           return (
                             <span>{tongphaitra.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")}</span>
                           )
            ...
            <div>
              ...
              {(() => {
                         ...
                         {
                          return (
                            <span>{tongdatra.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")}</span>
                          )
            ...
            <div>
              ...
              {(() => {
                         ...
                         {
                          return (
                            <span>{tongconlai.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")}</span>
                          )
              ...
              <tr key={cd.id} id={"ketquadieutriitem"+cd.id} data-itemcd={cd.id}>
                ...
                <td data-icd={cd.id}>{cd.tongtien.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")} VNĐ</td>
                     ...
                     {(() => {
                         ...
                         {
                            return (
                                <td data-icd={cd.id}>Chưa chọn hình thức</td>
                             )
                         }
                    })()}
                ...
                {(() => {
                         ...
                         {
                             return (
                              <button data-idthanhtoan={cd.id} onClick={this.getdulieuxoa} data-toggle="modal" data-target="#xoakhachhang" className="icon-list-demo btn btn-danger btn-circle btn-xl" data-idthanhtoan={cd.id}>
            ...
            <tbody>
                ...
                {chiphi.map((cd, index) => ( 
                    ...
                    {(() => {
                       ...
                       if(chitietthanhtoan.length > 1 || typeof chitietthanhtoan[index] !== 'undefined')
                       {
                    ...
                    <td> 
                     ...
                     {(() => {
                         ...
                         else
                         {
                          ...
                          if(chitietthanhtoan.length >= 0 && typeof chitietthanhtoan[index] !== 'undefined')
                          {
                ...
                <select className="form-control" name="hinhthucthanhtoan" id="hinhthucthanhtoan" onChange={this.handleFieldChange}>
                            ...
                            <option value={3} >Chưa chọn hình thức</option>
                    </select>
