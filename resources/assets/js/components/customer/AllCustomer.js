...
const { bacsilist } = this.state;
    return (
        ...
        <form onSubmit={this.handleBoLocKhachHang} className="row col-md-12 m-b-40">
  ...
  <div className="col-lg-6">
              ...
              <input type="text" className="form-control mydatepicker" name="thoigianhen" autocomplete="off" placeholder="dd/mm/yyyy" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
              </div>
              <div className="input-group hidden" id="inputkhoangngayhen">
              <input className="form-control input-daterange-datepicker"  value="" autocomplete="off" type="text" name="khoangngayhen" placeholder="mm/dd/yyyy - mm/dd/yyyy" defaultValue="" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
        ...
        <div className="col-lg-6">
              ...
              <input type="text" className="form-control" name="chuoicantim" autocomplete="off" placeholder="Họ tên, Số điện thoại hoặc Mã khách hàng" onChange={this.handleFieldChange} />
        ...
        <div className="row">
                    <div className="col-lg-12">
                        <div className="white-box">
                            <h3 className="box-title m-b-0">Danh sách khách hàng <button className="btn btn-primary" onClick={this.handleReset}><i class="fa fa-refresh"></i></button></h3>
