...
handleFieldChange (event) {
 ...
 getdulieuxoa(event)
  ...
  render() {
 const { chiphi,dieutridichvulist,thongkechiphi,idkhachhang,usercurrent } = this.state
          ...
          <table className="table-bordered table-hover table color-table primary-table" >
            ...
            {chiphi.map((cd, index) => ( 
              <tr key={cd.id} id={"ketquadieutriitem"+cd.id} data-itemcd={cd.id}>
                ...
                <td data-icd={cd.id} id={"cotdichvu"+cd.id}>{cd.ngaytao}</td>
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          <div className="modal-header">
            ...
            <h4 className="modal-title" id="exampleModalLabel1">Tạo Chi Phí</h4> </div>
