...
@font-face { 
  font-family: 'DXIcons'; 
  src: url('http://103.57.222.116/node_modules/devextreme/dist/css/icons/dxicons.woff') format('woff'), url('http://103.57.222.116/node_modules/devextreme/dist/css/icons/dxicons.ttf') format('truetype'); font-weight: normal; font-style: normal; }
.dx-icon-add {
  font: 14px/1 DXIcons;
}
.dx-icon-add::before {
